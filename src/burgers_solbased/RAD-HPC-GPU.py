...
def main(k=1, c=1, NumDomain=2000, NumResamples=100, method="Random"): # Main Code
    ...
    dde.saveplot(losshistory, train_state, issave=True, isplot=False, 
                 loss_fname=f"GPU_uxut1_{method}_k{k}c{c}_N{NumDomain}_L{NumResamples}_loss_info.dat", 
                 train_fname=f"GPU_uxut1_{method}_k{k}c{c}_N{NumDomain}_L{NumResamples}_finalpoints.dat", 
                 test_fname=f"GPU_uxut1_{method}_k{k}c{c}_N{NumDomain}_L{NumResamples}_finalypred.dat",
