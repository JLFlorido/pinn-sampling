""" Inserted two functions for d(pde)/dx and d(pde)/dt so can calculate how those look throughout solution process for Burger's Equation, and plots for me to see. Will have to do with a smaller number of points.


Usage:
    res_gradients_analysis.py [--k=<hyp_k>] [--c=<hyp_c>] [--N=<NumDomain>] [--L=<NumResamples> ] [--IM=<InitialMethod>] [--DEP=<depth>] [--INP1=<input1>]
    res_gradients_analysis.py -h | --help
Options:
