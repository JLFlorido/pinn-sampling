...
replacement_v01.py. Running on different IC, a combination of sin curves.

Usage:
    replacement_v01.py [--k=<hyp_k>] [--c=<hyp_c>] [--N=<NumDomain>] [--L=<NumResamples> ] [--IM=<InitialMethod>] [--DEP=<depth>] [--INP1=<input1>]
    replacement_v01.py -h | --help
Options:
...
def gen_testdata(): # This function opens the ground truth solution. Need to change path directory for running in ARC.
    data = np.load("./Burgers_v_0.01.npz")
