...
data_256 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N256_nt101.npz")
t_256, x_256, u_256 = data_256["t"], data_256["x"], data_256["exact"].T

data_800 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N800_nt201.npz")
t_800, x_800, u_800 = data_800["t"], data_800["x"], data_800["exact"].T

data_1600 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N1600_nt401.npz")
t_1600, x_1600, u_1600 = data_1600["t"], data_1600["x"], data_1600["exact"].T
u_1600to800 = u_1600[::2,::2]

data_3200 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N3200_nt801.npz")
_, _, u_3200 = data_3200["t"], data_3200["x"], data_3200["exact"].T
u_3200to1600 = u_3200[::2,::2]

data_6400 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N6400_nt1601.npz")
_, _, u_6400 = data_6400["t"], data_6400["x"], data_6400["exact"].T
u_6400to3200 = u_6400[::2,::2]

data_12800 = np.load(f"src/burgers_solbased/npzs/Burgers_IC_{IC}_N12800_nt3201.npz")
