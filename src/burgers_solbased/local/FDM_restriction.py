...
# np.savez(f"src/burgers_solbased/Burgers_IC_{IC}.npz", t=new_t, x=new_x, usol=u_12800to256)
...
plt.subplot(2, 1, 1)
plt.imshow(u_12800.T, extent=[0, 1, -1, 1], aspect='auto', cmap='rainbow')
plt.title('Original Matrix')
plt.colorbar()

plt.subplot(2, 1, 2)
plt.imshow(u_12800to256.T, extent=[0, 1, -1, 1], aspect='auto', cmap='rainbow')
