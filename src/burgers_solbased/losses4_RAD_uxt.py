"""losses4_RAD_uxt.py This code attempts to save 4 loss metrics.
Training loss is interpreted as PDE residuals; take it everywhere, and at collocation points. 
Test loss is interpreted as error; everywhere, and at collocation points.
...
def main(k=1, c=1, NumDomain=2000, NumResamples=100, method="Random"): # Main Code
    ...
    y_points = model.predict(model.data.anchors)
