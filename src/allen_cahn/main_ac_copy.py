"""Running 0.0001. Can't get true error so commenting out those bits.

Usage:
    main_ac_copy.py [--k=<hyp_k>] [--c=<hyp_c>] [--N=<NumDomain>] [--L=<NumResamples> ] [--IM=<InitialMethod>] [--DEP=<depth>] [--INP1=<input1>]
    main_ac_copy.py -h | --help
Options:
...
if __name__ == "__main__":
    ...
    time_taken = main(c=c, k=k, NumDomain=NumDomain,NumResamples=NumResamples,method=method, depth=depth, input1=input1) # Run main, record error history and final accuracy.
