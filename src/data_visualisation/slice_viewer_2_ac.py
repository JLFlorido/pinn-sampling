"""
slice_viewer_2_ac.py This reads and displays points before and after the resample, as well as the 
...
iter = "1"
# Import filenames
fname_0_points = f"results/raw/ac/slices/ac_points_before_{method}_0_{iter}.txt"
fname_49_points = f"results/raw/ac/slices/ac_points_before_{method}_49_{iter}.txt"

fname_0_pred = f"results/raw/ac/slices/ac_pred_sol_{method}_0_{iter}.txt"
fname_49_pred = f"results/raw/ac/slices/ac_pred_sol_{method}_49_{iter}.txt"
fname_0_pred_x = f"results/raw/ac/slices/ac_pred_x_{method}_0_{iter}.txt"
fname_49_pred_x = f"results/raw/ac/slices/ac_pred_x_{method}_49_{iter}.txt"

fname_0_output_points = f"results/raw/ac/slices/ac_points_after_{method}_0_{iter}.txt"
fname_49_output_points = f"results/raw/ac/slices/ac_points_after_{method}_49_{iter}.txt"
